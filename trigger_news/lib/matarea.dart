...
class Matares extends StatefulWidget {
  const Matares({super.key, this.cityid, this.city, this.stateid});
  final cityid;
  final city;
  final stateid;
                ...
                child: OutlinedButton(
                  onPressed: () async {
                    if (areaindex != null) {
                      ...
                      // data["state_id"] = widget.stateid;
                      // data["city_id"] = widget.cityid;
                      // data["area_name"] = area_name;
                      // log("$data");
                      // var resdata =
                      //     await apiService.postCall("matarea/addmatarea", data);
