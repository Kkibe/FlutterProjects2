...
import 'package:trigger_news/Profiletab/Jobsprofile.dart';
import 'package:trigger_news/Profiletab/categorized.dart';
import 'package:trigger_news/Profiletab/localprofile.dart';
import 'package:trigger_news/Profiletab/newsprofile.dart';
import 'package:trigger_news/Profiletab/otherprofile.dart';
import 'package:trigger_news/Wallet/wallet.dart';
...
class _ProfileState extends State<Profile> {
  ...
  init() async {
    ...
    log("userid ${userid}");
    var resdata = await apiService.getCall('user/getuser/${userid}');
    log("${resdata}");
    setState(() {
      data1 = resdata['data'];
      if (widget.i == null) {
