                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child: ElevatedButton(
                                                                                ...
                                                                                onPressed: () {},
                                                                                child: Text(textScaleFactor: 1.0, "Submit")),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ],
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            param['comment'] =
                                                                                comment.text;
                                                                            var resdata =
                                                                                await apiService.postCall('comments/addcomments', param);
                                                                            if (resdata['success'] ==
                                                                                1) {
                                                                              comment.text = '';
                                                                              getComments();
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            child:
                                                                                TextFormField(
                                                                              controller: comment,
                                                                              decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(vertical: 10, horizontal: 10), border: OutlineInputBorder(borderRadius: BorderRadius.circular(5)), hintText: "Add Comment"),
                                                                            ),
                                                                          ),
                                                                          SizedBox(
                                                                            width:
                                                                          ...
                                                                          GestureDetector(
                                                                            onTap:
                                                                              ...
                                                                              var resdata = await apiService.postCall('comments/addcomments', param);
